...
class OrganizationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('organizations')->insert([
        ...
        array('name' => 'not organization', 'status'=>1, 'deleted_or_not'=>1,  'date_started' => date('Y-m-d H:i:s'), 'date_expired' => date('Y-m-d H:i:s'), 'url' => 'pi.org.ph', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')),
      ]);
    }
}
