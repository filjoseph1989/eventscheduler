...
@section('page-title', 'Position Registration')
      ...
      <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="card">
            <div class="header">
              <div class="row clearfix">
                <div class="col-xs-12 col-sm-6">
                  <h2 id="heading-schedule">Position Registration</h2>
                </div>
              </div>
            ...
            <div class="body">
              <form class="" role="form" method="POST" action="{{ route('user.position.registered') }}">
                  {{ csrf_field() }}
                <div class="row clearfix">
