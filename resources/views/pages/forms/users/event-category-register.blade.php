...
@section('page-title', 'Event Category Registration')
      ...
      <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="card">
            <div class="header">
              <div class="row clearfix">
                <div class="col-xs-12 col-sm-6">
                  <h2 id="heading-schedule">Event Category Registration</h2>
                </div>
              </div>
            ...
            <div class="body">
              <form class="" role="form" method="POST" action="{{ route('user.event-category.registered') }}">
                  {{ csrf_field() }}
                <div class="row clearfix">
