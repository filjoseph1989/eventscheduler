                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                      @if ($orgHead === true AND $isMember === true)
                        <li><a href="{{ route('user-admin.org-edit', $organization->id) }}"><i class="material-icons">create</i> Edit</a></li>
                      @else
              ...
              <div class="body table-responsive">
                <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    @endif
                    @if ($orgHead === true AND $isMember === true)
                      <form action="{{ route('user-admin.org-logo') }}" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }}
                        <div class="row">&nbsp;</div>
                        <div class="row">
                          <div class="col-md-12">
                  ...
                  <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        @if ($isMember == false)
                          <form class="" action="{{ route('user-admin.org-membership', $organization->id ) }}" method="post">
                            {{ csrf_field() }}
