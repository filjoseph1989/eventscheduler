                    ...
                    @if (isset($event))
                      @foreach ($event as $key => $value)
                        <tr data-id="{{ $value->id }}">
                          ...
                          <td>
                            <a href="{{ route('user-admin.approved.event', [$value->id] ) }}" title="approve this event">
                              <i class="material-icons">thumb_up</i>
                            </a>
                            <a href="#" class="event-details" title="further details" data-toggle="modal" data-target="#event-details">
                              <i class="material-icons">visibility</i>
                            </a>
                            <a href="{{ route('user-admin.disapproved.event', [$value->id] ) }}" class="" title="disapprove this event">
