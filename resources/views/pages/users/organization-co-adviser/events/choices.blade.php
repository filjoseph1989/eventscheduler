      ...
      <div class="container-fluid">
        ...
        <div class="row clearfix">
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a href="{{ route('org-co-adviser.event.list', 1) }}">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a href="{{ route('org-co-adviser.event.list', 2) }}">
              <div class="info-box hover-expand-effect">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a href="{{ route('org-co-adviser.event.list', 3) }}">
              <div class="info-box hover-expand-effect">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a href="{{ route('org-co-adviser.event.list', 4) }}">
              <div class="info-box hover-expand-effect">
