                    ...
                    @if (isset($data))
                      @foreach ($data as $usersKey => $usersvalue)
                        <tr data-id="{{ $usersvalue->id }}">
                          ...
                          <td>
                            <a href="#" class="users-delete delete" data-url="/users/user/delete" data-type="cancel">
...
@section('modal')
  ...
  <div class="modal fade" id="edit-user" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="" id="user-update" role="form" method="POST" action="{{ route('user.edit') }}">
          {{ csrf_field() }}
  ...
  <div class="modal fade" id="add-user" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="" id="user-registration" role="form" method="POST" action="{{ route('user.register') }}">
          {{ csrf_field() }}
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
