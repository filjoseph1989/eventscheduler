                ...
                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                  ...
                  <tbody class="js-sweetalert">
                    ...
                    <tr data-id="{{ $usersvalue->id }}">
                      ...
                      <td>
                        <a href="#" class="department-delete delete" data-url="/users/department/delete" data-type="cancel"> <i class="material-icons">delete</i> </a>
...
@section('modal')
  ...
  <div class="modal fade" id="edit-department" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="" id="department-update" role="form" method="POST" action="{{ route('department.edit') }}">
          {{ csrf_field() }}
  ...
  <div class="modal fade" id="add-department" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="" id="department-registration" role="form" method="POST" action="{{ route('department.register') }}">
          {{ csrf_field() }}
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
