                    ...
                    @if (isset($courses))
                      @foreach ($courses as $usersKey => $usersvalue)
                        <tr data-id="{{ $usersvalue->id }}">
                          ...
                          <td>
                            <a href="#" class="course-delete delete" data-url="/users/course/delete" data-type="cancel"> <i class="material-icons">delete</i> </a>
...
@section('modal')
  ...
  <div class="modal fade" id="edit-course" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="" id="course-update" role="form" method="POST" action="{{ route('course.edit') }}">
          {{ csrf_field() }}
  ...
  <div class="modal fade" id="add-course" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="" id="course-registration" role="form" method="POST" action="{{ route('course.register') }}">
          {{ csrf_field() }}
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
