  ...
  @endif
    @if (session('account') == 'osa')
      <h2 style="color:white"> MANAGE SCHEDULE
        <small style="color:white">In this panel you view or add your personal event/s or events for your office</small>
      </h2>
    @elseif (session('account') == 'org-head')
      <h2 style="color:black"> MANAGE SCHEDULE
        <small style="color:black">In this panel you view or add your personal event/s or events for your organization</small>
      </h2>
    @else
      <h2 style="color:white"> MANAGE SCHEDULE
        <small style="color:white">In this panel you view or add your personal event/s</small>
      </h2>
    @endif
  </div>
  <div class="body">
