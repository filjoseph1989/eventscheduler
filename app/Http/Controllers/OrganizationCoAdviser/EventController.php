...
class EventController extends Controller
{
    ...
    public function index($id = null)
    {
      ...
      $login_type = "user";
      if ($id == null) {
        return view('pages/users/organization-co-adviser/events/choices', compact(
          'login_type'
        ));
      } else {
        if ($id != 4) {
          ...
          return view('pages/users/organization-co-adviser/events/list', compact(
          ...
          $event = PersonalEvent::where('date_start', '>=', date('m'))
            ...
            ->get();
          return view('pages/users/organization-co-adviser/events/mylist', compact(
            'login_type', 'event', 'id'
          ));
        } else {
          return back();
    ...
    public function create()
    {
      ...
      return view('pages/users/organization-co-adviser/events/form', compact(
    ...
    public function manageNotification()
    {
      ...
      $login_type = "user";
      return view('pages/users/organization-co-adviser/events/list0')->with([
        'login_type' => $login_type,
        'event'      => $event,
      ]);
    }
    ...
    public function manageNotificationMenu()
    {
      ...
      $login_type = "user";
      return view('pages/users/organization-co-adviser/events/manage-notif-menu')->with([
        'login_type' => $login_type,
        'event'      => $event
      ]);
    }
