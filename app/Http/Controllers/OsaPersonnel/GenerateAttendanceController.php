...
class GenerateAttendanceController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index()
    {
        ...
        $login_type = 'user';
        return view('pages/users/osa-personnel/events/org-list', compact(
          'org', 'login_type'
        ));
    }
    ...
    public function show($id, $eid)
    {
      ...
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/attendance',
        compact(
    ...
    public function generateAttendanceMenu()
    {
      ...
      $this->osa_personnel->isOsaPersonnel();
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/generate-attendance-menu', compact(
        'login_type'
      ));
    }
    ...
    public function declinedAttendanceOrgList()
    {
      ...
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/declined-attendance-org-list', compact(
        'org', 'login_type'
      ));
    }
    ...
    public function confirmedAttendanceOrgList()
    {
      ...
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/confirmed-attendance-org-list', compact(
        'org', 'login_type'
      ));
    }
    ...
    public function officialAttendanceOrgList()
    {
      ...
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/official-attendance-org-list', compact(
        'org', 'login_type'
      ));
    }
    ...
    public function generateConfirmedAttendanceEventList($id = null)
    {
      ...
      $login_type = 'user';
      return view('pages\users\osa-personnel\generate-attendance\confirmed_attendance_event_list', compact(
        'event', 'login_type'
      ));
    }
    ...
    public function generateOfficialAttendanceEventList($id = null)
    {
      ...
      $login_type = 'user';
      return view('pages\users\osa-personnel\generate-attendance\official_attendance_event_list', compact(
        'event', 'login_type'
      ));
    }
    ...
    public function generateDeclinedAttendanceEventList($id = null)
    {
      ...
      $login_type = 'user';
      return view('pages\users\osa-personnel\generate-attendance\declined_attendance_event_list', compact(
        'event', 'login_type'
      ));
    }
    ...
    public function declinedAttendanceMemberList($id, $eid)
    {
      ...
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/declined-attendance-member-list', compact(
    ...
    public function confirmedAttendanceMemberList($id, $eid)
    {
      ...
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/confirmed-attendance-member-list', compact(
        'login_type', 'att_sheet', 'organization', 'event', 'att', 'pos2', 'org'
      ));
    }
    ...
    public function officialAttendanceMemberList($id, $eid)
    {
      ...
      $login_type = 'user';
      return view('pages/users/osa-personnel/generate-attendance/official-attendance-member-list', compact(
        'login_type', 'att_sheet', 'organization', 'event', 'att', 'pos2', 'org'
      ));
    }
