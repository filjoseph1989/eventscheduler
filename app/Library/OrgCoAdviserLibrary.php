 ...
 * @updated 2017-07-29
 */
class OrgCoAdviserLibrary extends Controller
{
  /**
   ...
   * @return
   */
  public function isCoAdviserInGivenOrganization($id)
  {
    $co_adviser = OrganizationAdviserGroup::where('organization_id', '=', $id)->get();
  }
